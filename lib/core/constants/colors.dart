...
const Color primaryColor = Color(0xFF0C1050); // Dark Navy Blue
const Color secondaryColor = Color(0xFFFEE487); // Yellow/Gold
const Color ternaryColor = Color(0xFFCE9838); // Dark Gold
